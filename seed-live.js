...
const VENDORS = [
  { name: 'Zydus Healthcare Ltd', trade: 'Zydus Cadila', cat: 'PHARMA', gstin: '00XXXXX0000X0X0', pan: 'XXXXX0000X', city: 'Ahmedabad', state: 'Gujarat', pin: '380015', contact: 'Rajesh Mehta', phone: '9800000000', email: 'test@example.com', credit: 30, bank: 'HDFC Bank', ifsc: 'XXXX0000000', acct: '00000000000000' },
  { name: 'Torrent Pharmaceuticals Ltd', trade: 'Torrent Pharma', cat: 'PHARMA', gstin: '00XXXXX0000X0X0', pan: 'XXXXX0000X', city: 'Ahmedabad', state: 'Gujarat', pin: '380054', contact: 'Vivek Shah', phone: '9800000000', email: 'test@example.com', credit: 45, bank: 'ICICI Bank', ifsc: 'XXXX0000000', acct: '00000000000000' },
  { name: 'Intas Pharmaceuticals Ltd', trade: 'Intas Pharma', cat: 'PHARMA', gstin: '00XXXXX0000X0X0', pan: 'XXXXX0000X', city: 'Ahmedabad', state: 'Gujarat', pin: '380061', contact: 'Hiren Patel', phone: '9800000000', email: 'test@example.com', credit: 30, bank: 'Kotak Mahindra', ifsc: 'XXXX0000000', acct: '00000000000000' },
  { name: 'Sun Pharmaceutical Distributors', trade: 'Sun Pharma', cat: 'PHARMA', gstin: '00XXXXX0000X0X0', pan: 'XXXXX0000X', city: 'Vadodara', state: 'Gujarat', pin: '390007', contact: 'Amit Desai', phone: '9800000000', email: 'test@example.com', credit: 30, bank: 'SBI', ifsc: 'XXXX0000000', acct: '00000000000000' },
  { name: 'Cadila Healthcare Ltd', trade: 'Cadila', cat: 'PHARMA', gstin: '00XXXXX0000X0X0', pan: 'XXXXX0000X', city: 'Ahmedabad', state: 'Gujarat', pin: '380019', contact: 'Ketan Joshi', phone: '9800000000', email: 'test@example.com', credit: 45, bank: 'Axis Bank', ifsc: 'XXXX0000000', acct: '00000000000000' },
  { name: 'Cipla Gujarat Division', trade: 'Cipla', cat: 'PHARMA', gstin: '00XXXXX0000X0X0', pan: 'XXXXX0000X', city: 'Ahmedabad', state: 'Gujarat', pin: '380009', contact: 'Nirav Vyas', phone: '9800000000', email: 'test@example.com', credit: 60, bank: 'HDFC Bank', ifsc: 'XXXX0000000', acct: '00000000000000' },
  { name: 'Johnson & Johnson Medical India', trade: 'J&J Medical', cat: 'SURGICAL', gstin: '00XXXXX0000X0X0', pan: 'XXXXX0000X', city: 'Ahmedabad', state: 'Gujarat', pin: '380058', contact: 'Prashant Kumar', phone: '9800000000', email: 'test@example.com', credit: 45, bank: 'Citibank', ifsc: 'XXXX0000000', acct: '00000000000000' },
  { name: 'Medtronic India Pvt Ltd', trade: 'Medtronic', cat: 'SURGICAL', gstin: '00XXXXX0000X0X0', pan: 'XXXXX0000X', city: 'Mumbai', state: 'Maharashtra', pin: '400093', contact: 'Ankit Sharma', phone: '9800000000', email: 'test@example.com', credit: 60, bank: 'Standard Chartered', ifsc: 'XXXX0000000', acct: '00000000000000' },
  { name: 'BD India Pvt Ltd', trade: 'Becton Dickinson', cat: 'SURGICAL', gstin: '00XXXXX0000X0X0', pan: 'XXXXX0000X', city: 'Ahmedabad', state: 'Gujarat', pin: '380015', contact: 'Deepak Patel', phone: '9800000000', email: 'test@example.com', credit: 30, bank: 'HDFC Bank', ifsc: 'XXXX0000000', acct: '00000000000000' },
  { name: 'B Braun Medical India', trade: 'B Braun', cat: 'SURGICAL', gstin: '00XXXXX0000X0X0', pan: 'XXXXX0000X', city: 'Ahmedabad', state: 'Gujarat', pin: '380059', contact: 'Manish Thakkar', phone: '9800000000', email: 'test@example.com', credit: 45, bank: 'Bank of Baroda', ifsc: 'XXXX0000000', acct: '00000000000000' },
  { name: 'Romsons International', trade: 'Romsons', cat: 'SURGICAL', gstin: '00XXXXX0000X0X0', pan: 'XXXXX0000X', city: 'Agra', state: 'Uttar Pradesh', pin: '282001', contact: 'Rakesh Gupta', phone: '9800000000', email: 'test@example.com', credit: 30, bank: 'PNB', ifsc: 'XXXX0000000', acct: '00000000000000' },
  { name: 'Mindray Medical India', trade: 'Mindray', cat: 'EQUIPMENT', gstin: '00XXXXX0000X0X0', pan: 'XXXXX0000X', city: 'Mumbai', state: 'Maharashtra', pin: '400072', contact: 'Chen Wei', phone: '9800000000', email: 'test@example.com', credit: 90, bank: 'HSBC', ifsc: 'XXXX0000000', acct: '00000000000000' },
  { name: 'Philips Healthcare India', trade: 'Philips', cat: 'EQUIPMENT', gstin: '00XXXXX0000X0X0', pan: 'XXXXX0000X', city: 'Pune', state: 'Maharashtra', pin: '411006', contact: 'Rahul Khanna', phone: '9800000000', email: 'test@example.com', credit: 90, bank: 'Deutsche Bank', ifsc: 'XXXX0000000', acct: '00000000000000' },
  { name: 'Roche Diagnostics India', trade: 'Roche', cat: 'DIAGNOSTICS', gstin: '00XXXXX0000X0X0', pan: 'XXXXX0000X', city: 'Mumbai', state: 'Maharashtra', pin: '400076', contact: 'Sanjay Mishra', phone: '9800000000', email: 'test@example.com', credit: 60, bank: 'HDFC Bank', ifsc: 'XXXX0000000', acct: '00000000000000' },
  { name: 'Transasia Bio-Medicals', trade: 'Transasia', cat: 'DIAGNOSTICS', gstin: '00XXXXX0000X0X0', pan: 'XXXXX0000X', city: 'Mumbai', state: 'Maharashtra', pin: '400063', contact: 'Sunil Kumar', phone: '9800000000', email: 'test@example.com', credit: 45, bank: 'Axis Bank', ifsc: 'XXXX0000000', acct: '00000000000000' },
  { name: 'Diversey India Pvt Ltd', trade: 'Diversey', cat: 'HOUSEKEEPING', gstin: '00XXXXX0000X0X0', pan: 'XXXXX0000X', city: 'Mumbai', state: 'Maharashtra', pin: '400076', contact: 'Mahesh Yadav', phone: '9800000000', email: 'test@example.com', credit: 30, bank: 'HDFC Bank', ifsc: 'XXXX0000000', acct: '00000000000000' },
  { name: 'Satguru Enterprises', trade: 'Satguru', cat: 'HOUSEKEEPING', gstin: '00XXXXX0000X0X0', pan: 'XXXXX0000X', city: 'Ahmedabad', state: 'Gujarat', pin: '380007', contact: 'Ramesh Suthar', phone: '9800000000', email: 'test@example.com', credit: 15, bank: 'SBI', ifsc: 'XXXX0000000', acct: '00000000000000' },
  { name: 'Abbott Nutrition India', trade: 'Abbott', cat: 'DIETARY', gstin: '00XXXXX0000X0X0', pan: 'XXXXX0000X', city: 'Mumbai', state: 'Maharashtra', pin: '400013', contact: 'Pooja Verma', phone: '9800000000', email: 'test@example.com', credit: 45, bank: 'Kotak Mahindra', ifsc: 'XXXX0000000', acct: '00000000000000' },
  { name: 'Dell Technologies India', trade: 'Dell', cat: 'IT', gstin: '00XXXXX0000X0X0', pan: 'XXXXX0000X', city: 'Bengaluru', state: 'Karnataka', pin: '560103', contact: 'Arun Krishnan', phone: '9800000000', email: 'test@example.com', credit: 30, bank: 'Citibank', ifsc: 'XXXX0000000', acct: '00000000000000' },
  { name: 'INOX Air Products Ltd', trade: 'INOX', cat: 'EQUIPMENT', gstin: '00XXXXX0000X0X0', pan: 'XXXXX0000X', city: 'Vadodara', state: 'Gujarat', pin: '390023', contact: 'Pramod Jain', phone: '9800000000', email: 'test@example.com', credit: 30, bank: 'HDFC Bank', ifsc: 'XXXX0000000', acct: '00000000000000' },
];
