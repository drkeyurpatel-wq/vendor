...
│   │   ├── vendors/[id]/page.tsx          ✅ DONE — vendor detail
│   │   ├── items/page.tsx                 ✅ DONE — list
│   │   ├── items/new/page.tsx             ✅ DONE — add form
│   │   ├── items/[id]/page.tsx            ✅ DONE — item detail + stock + vendor ranks
│   │   ├── items/stock/page.tsx           ✅ DONE — stock levels
│   │   ├── purchase-orders/page.tsx       ✅ DONE — list
│   │   ├── purchase-orders/new/page.tsx   ✅ DONE — full PO form
│   │   ├── purchase-orders/[id]/page.tsx  ✅ DONE — detail + approve
│   │   ├── purchase-orders/indents/page.tsx ✅ DONE — indent list + filters
│   │   ├── grn/page.tsx                   ✅ DONE — list
│   │   ├── grn/new/page.tsx               ✅ DONE — create GRN
│   │   ├── grn/[id]/page.tsx              ✅ DONE — GRN detail
│   │   ├── finance/invoices/page.tsx      ✅ DONE
│   │   ├── finance/credit/page.tsx        ✅ DONE — aging dashboard
│   │   ├── finance/payments/page.tsx      ✅ DONE — payment batches
│   │   ├── reports/page.tsx               ✅ DONE
│   │   └── settings/users/page.tsx        ✅ DONE
│   └── api/
│       ├── auth/callback/route.ts         ✅ DONE
│       ├── po/approve/route.ts            ✅ DONE
│       ├── grn/submit/route.ts            ✅ DONE
│       └── invoices/match/route.ts        ✅ DONE — 3-way matching engine
├── components/
│   ├── layout/Sidebar.tsx                 ✅ DONE
│   ├── layout/TopBar.tsx                  ✅ DONE
│   └── ui/
│       ├── VendorSearch.tsx               ✅ DONE — autocomplete
│       ├── ItemSearch.tsx                 ✅ DONE — autocomplete
│       ├── POLineItems.tsx                ✅ DONE — dynamic line items
│       └── ApprovalTimeline.tsx           ✅ DONE — visual timeline
├── lib/
