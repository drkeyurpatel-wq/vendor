...
export default function DashboardError({
  ...
  return (
    <div className="flex-1 flex items-center justify-center px-4 py-16" role="alert">
      <div className="card p-8 max-w-md w-full text-center">
        ...
        <p className="text-sm text-gray-500 mb-6">
          An error occurred while loading this page. Your data is safe — please try again or return to the dashboard.
        </p>
